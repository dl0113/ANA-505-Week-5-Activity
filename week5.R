...
mysample2<-mysample
mysample2<-mysample2 %>% arrange(airline)
mysample2<-mysample2 %>% filter(incidents_85_99<25)
mysample2<-mysample2 %>% rename(seats = avail_seat_km_per_week)
mysample2<-mysample2 %>% select(incidents_00_14, incidents_85_99)
mysample2<-mysample2 %>% summary()
print(mysample2)
